...
To optimize the jhipsterGatewayApplication application for production, run:
...
Then navigate to [http://localhost:9091](http://localhost:9091) in your browser.
